...
class App extends Component {
  ...
  */
  render() {
  const { workers, posts, isFetching, editElementId,workerName } = this.props
  	return (  	
  		<div className='App'>
        ...
        <div className='content'>   
            ...
            <Staff actions = {this.props.actions}  
    		 			workers = {workers}
    		 			posts = {posts}
...
const filterElements = (workers, str) =>{
  if (!workers[0]) return;
  return workers.filter((i)=> (i.first_name.toUpperCase().indexOf(str) + 1)||(i.last_name.toUpperCase().indexOf(str) + 1));
}
